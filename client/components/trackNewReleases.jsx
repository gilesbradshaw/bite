...
import {trackNewRelease as Store} from "../stores/store";
import {trackNewRelease as Actions} from "../actions/actions";
...
var exp = crudFactory(crud, "trackId", "TrackNewRelease", "TrackNewReleases", Actions, Store, "trackId", "id")
